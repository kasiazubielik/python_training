...
#         assert contact_from_home_page.address == contact_info_from_db.address
#         assert contact_from_home_page.all_emails_from_home_page == merge_emails_like_home_page(contact_info_from_db)
#         assert contact_from_home_page.all_phones_from_home_page == merge_phones_like_home_page(contact_info_from_db)
